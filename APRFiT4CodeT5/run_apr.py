...
def main():
    ...
    if args.do_train:
        ...
        train_sampler_temp = RandomSampler(train_dataset) if args.local_rank == -1 else DistributedSampler(train_dataset)
        train_dataloader_temp = DataLoader(train_dataset, sampler=train_sampler_temp, batch_size=args.train_batch_size,
                                      num_workers=4, pin_memory=True)
        ...
        num_train_optimization_steps = args.num_train_epochs * len(train_dataloader_temp)
        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            curriculum = len(train_dataloader_temp) * args.num_train_epochs
    ...
    if args.do_test:
        ...
        for criteria in ['best-bleu']:
            file = "your_path/codet5_bfp_small_or_medium.bin"
